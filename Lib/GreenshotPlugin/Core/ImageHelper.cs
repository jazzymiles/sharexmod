...
namespace GreenshotPlugin.Core
{
    ...
    public static class ImageHelper
    {
        ...
        {
            Bitmap returnImage = CreateEmpty(sourceBitmap.Width, sourceBitmap.Height, PixelFormat.Format32bppArgb, Color.White, sourceBitmap.HorizontalResolution, sourceBitmap.VerticalResolution);
