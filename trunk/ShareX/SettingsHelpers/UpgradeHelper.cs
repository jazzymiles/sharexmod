                ...
                foreach (EActivity act in wf.Activities)
                {
                    switch (act)
                    {
                        ...
                        case EActivity.ClipboardCopyImage:
                            wf.Subtasks |= HelpersLib.Subtask.CopyImageToClipboard;
                            break;
                        case EActivity.ImageAnnotate:
                            wf.Subtasks |= HelpersLib.Subtask.AnnotateImage;
                            break;
                        case EActivity.ImageAnnotateAddShadowBorder:
                            wf.Subtasks |= HelpersLib.Subtask.AnnotateImageAddShadowBorder;
                            break;
                        case EActivity.ImageAnnotateAddTornEffect:
                            wf.Subtasks |= HelpersLib.Subtask.AnnotateImageAddTornEffect;
                            break;
                        case EActivity.Printer:
                            wf.Subtasks |= HelpersLib.Subtask.Print;
                            break;
                        case EActivity.SaveToFile:
                            wf.Subtasks |= HelpersLib.Subtask.SaveToFile;
                            break;
                        case EActivity.SaveToFileWithDialog:
                            wf.Subtasks |= HelpersLib.Subtask.SaveImageToFileWithDialog;
                            break;
                        ...
                        case EActivity.ShowImageEffectsStudio:
                            wf.Subtasks |= HelpersLib.Subtask.ShowImageEffectsStudio;
                            break;
                        ...
                        case EActivity.UploadToRemoteHost:
                            wf.Subtasks |= HelpersLib.Subtask.UploadToRemoteHost;
                            break;
