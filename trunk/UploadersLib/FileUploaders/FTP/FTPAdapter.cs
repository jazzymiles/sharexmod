    ...
    public class FTPAdapter
    {
        ...
        public bool Upload(Stream stream, string url)
        {
            try
            {
                ...
                request.Credentials = new NetworkCredential(Options.Account.Username, Options.Account.Password2);
        ...
        private void bw_AsyncUploadDoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                request.Method = WebRequestMethods.Ftp.UploadFile;
                request.Credentials = new NetworkCredential(this.Options.Account.Username, this.Options.Account.Password2);
                request.KeepAlive = false;
