...
namespace Greenshot
{
    public partial class ImageEditorForm : Form, IImageEditor
    {
        ...
        public void AddCaptureWindowMenuItems(ToolStripMenuItem menuItem, EventHandler eventHandler)
        {
            ...
            bool thumbnailPreview = coreConf.ThumnailPreview && DWM.isDWMEnabled();
        ...
        private void ShowThumbnailOnEnter(object sender, EventArgs e)
        {
            ...
            if (thumbnailForm == null)
            {
                ...
                if (coreConf.WindowCaptureMode == WindowCaptureMode.Auto || coreConf.WindowCaptureMode == WindowCaptureMode.Aero)
                {
                    thumbnailForm.BackColor = Color.FromArgb(255, coreConf.DWMBackgroundColor.R, coreConf.DWMBackgroundColor.G, coreConf.DWMBackgroundColor.B);
                }
                else
                {
